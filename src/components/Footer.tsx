        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              <span className="text-white font-semibold">ALFA AL HAYAT CO. LTD</span><br />
              Radiation Protection Experts<br /><br />
              Specialized in designing, installing & maintaining advanced radiation safety systems.
              Committed to high-level protection and custom safety solutions for every project.
            </p>
            {/* Social Links */}
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+966567169966" className="group flex items-start gap-3 text-slate-400 hover:text-green-400 transition-colors duration-300">
                  ...
                  <span className="text-sm pt-2">+966 567 16 9966</span>
                </a>
              </li>
              <li>
                <a href="https://www.alfaalhayat.com" target="_blank" rel="noopener noreferrer" className="group flex items-start gap-3 text-slate-400 hover:text-green-400 transition-colors duration-300">
                  <span className="w-10 h-10 rounded-xl bg-slate-800 group-hover:bg-green-500/20 flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                    <svg className="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                    </svg>
                  </span>
                  <span className="text-sm pt-2">www.alfaalhayat.com</span>
                </a>
              </li>
              <li>
                <a href="mailto:info@alfaalhayat.com" className="group flex items-start gap-3 text-slate-400 hover:text-green-400 transition-colors duration-300">
                  <span className="w-10 h-10 rounded-xl bg-slate-800 group-hover:bg-green-500/20 flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                    <svg className="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </span>
                  <span className="text-sm pt-2">info@alfaalhayat.com</span>
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-slate-500 text-sm text-center sm:text-left">
              © {new Date().getFullYear()} <span className="text-green-500">ALFA AL HAYAT Co. LTD.</span> All rights reserved.
            </p>
